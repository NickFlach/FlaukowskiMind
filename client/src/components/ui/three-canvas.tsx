    ...
    return (
      <div 
        ...
        style={{ 
          ...
          background: `linear-gradient(135deg, ${backgroundColor} 0%, #1a1a2e 50%, ${backgroundColor} 100%)`
        }}
        ...
        <div className="text-center">
          <div className="w-20 h-20 mx-auto mb-4 opacity-50">
            <svg viewBox="0 0 100 100" className="w-full h-full">
              ...
              <circle cx="25" cy="30" r="3" fill={accentColor} opacity="0.7"/>
              <circle cx="75" cy="30" r="3" fill={accentColor} opacity="0.7"/>
              <circle cx="30" cy="70" r="3" fill={accentColor} opacity="0.7"/>
              <circle cx="70" cy="70" r="3" fill={accentColor} opacity="0.7"/>
              <line x1="50" y1="50" x2="25" y2="30" stroke={primaryColor} strokeWidth="1" opacity="0.5"/>
              <line x1="50" y1="50" x2="75" y2="30" stroke={primaryColor} strokeWidth="1" opacity="0.5"/>
              <line x1="50" y1="50" x2="30" y2="70" stroke={primaryColor} strokeWidth="1" opacity="0.5"/>
              <line x1="50" y1="50" x2="70" y2="70" stroke={primaryColor} strokeWidth="1" opacity="0.5"/>
            </svg>
          </div>
          <p className="text-sm text-muted-foreground">Synaptic network</p>
        </div>
      </div>
    );
  }
